...
Look for and report only what you can actually SEE:
...
Return strict JSON, nothing else:
{
  ...
  "strongest_argument": "the single most persuasive sentence you could say to this owner about why their site needs replacing, written as plain speech, naming something visible in the screenshot"
}

Never invent anything you cannot see. If the page looks genuinely modern and well
made, say so plainly in every field rather than manufacturing faults.`;
